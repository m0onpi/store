  ...
  return (
    <div className="max-w-2xl mx-auto prose prose-blue">
      ...
      <p>
        ...
        wrong with your order, please let us know by contacting us at sigmachessmemes@gmail.com
      </p>

      <h2>Do you offer refunds?</h2>
      <p>
        Refunds are only offered to customers that receive the wrong items or
        damaged items. If any of these apply, please contact us at sigmachessmemes@gmail.com
      ...
      <p>
        ...
        that&apos;s the case, please let us know at sigmachessmemes@gmail.com
